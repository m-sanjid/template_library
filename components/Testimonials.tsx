	...
	return (
		<section className="py-20 px-4 sm:px-6 lg:px-8">
			<div className="max-w-7xl mx-auto relative">
				<SectionHeader label="Testimonials" title="Loved by Creators Worldwide" description="See what our users have to say about their experience." gradientText="TESTIMONIALS" textHeight={160} />
