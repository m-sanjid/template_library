...
const FeatureCard = ({ feature }: { feature: FeaturesType }) => {
  return (
    <Card className="rounded-3xl bg-black/5 p-[10px] dark:bg-white/5">
      <Card className="h-[24rem] overflow-hidden rounded-[16px]">
...
const FeatureCard2 = ({ feature }: { feature: FeaturesType }) => {
  return (
    <Card className="overflow-hidden rounded-3xl">
      <div className="h-[4rem] w-full rounded-t-lg bg-black/20"></div>
